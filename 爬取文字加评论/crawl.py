...
# 知识星球中的小组ID 生财有术 1824528822 caoz 8424258282
GROUP_ID = '8424258282'
# 生成PDF文件的名字
PDF_FILE_NAME = 'caoz-all-[有图]版本.pdf'
...
EARLY_DATE = '2019-04-15T00:00:00.000+0800'
...
def get_data(url):
    ...
    # }
    headers = {
        'Authorization': 'A2417DE1-D1B4-F72C-9D32-F00AE4C417E4',
        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36',
        'Cookie': 'zsxq_access_token=847C0E4B-38B6-2A21-4222-'
    }

    rsp = requests.get(url, headers=headers, verify=False)
    tempfilename = str(filecount) + '_' + str(num - 1)+"_json.txt"
    print(tempfilename)
    with open(tempfilename, 'w', encoding='utf-8') as f:  # 将返回数据写入temp.json方便查看
